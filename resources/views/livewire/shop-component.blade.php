                        ...
                        <div class="shop-top-control">
                            <div class="select-item select-form">
                                <span class="title">Filter Products</span>
                                    <select title="sort" wire:model="pagesize" data-placeholder="12 Products/Page" class="chosen-select">
                            ...
                            <div class="filter-choice select-form">
                                ...
                                <select title="sort-by" wire:model="sorting" data-placeholder="Price: Low to High" class="chosen-select">
                                            ...
                                            <div class="thumb-group">
                                                <div class="yith-wcwl-add-to-wishlist">
                                                    <div class="yith-wcwl-add-button">
                                                        ...
                                                        {{-- <button type="button" class="wishlist" style="background-color: rgb(5, 3, 0)" wire:click.prevent="removeFromWishlist({{ $product->id }})" title="Remove from Wishlist"><i class="fa fa-heart-o"></i></button> --}}
                                                        @else
                                                        <a href="#" wire:click.prevent="addToWishlist({{ $product->id }},'{{ $product->name }}',{{ $product->regular_price }})">Add to Wishlist</a>
                                                        {{-- <button type="button" class="wishlist"wire:click.prevent="addToWishlist({{ $featured_product->id }},'{{ $featured_product->name }}',{{ $featured_product->regular_price }})" title="Add to Wish List"><i class="fa fa-heart-o"></i></button> --}}
                                                        @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="loop-form-add-to-cart">
                                                    ...
                                                    <button type="button" class="single_add_to_cart_button button" style="background-color: rgb(0, 0, 0)"  wire:click.prevent="removeFromCart({{ $product->id }})">Remove From Cart</button>
                                                    @else
